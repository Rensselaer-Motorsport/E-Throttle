// ======================================================================
// E-Throttle-Mainboard.v generated from TopDesign.cysch
// 11/14/2015 at 22:02
...
module top ;
	...
	wire [0:0] tmpOE__TPS_2_net;
	wire [0:0] tmpFB_0__TPS_2_net;
	wire [0:0] tmpIO_0__TPS_2_net;
	wire [0:0] tmpINTERRUPT_0__TPS_2_net;
	electrical [0:0] tmpSIOVREF__TPS_2_net;

	cy_psoc3_pins_v1_10
		#(.id("9aa96c14-28cd-4b70-a3f8-9a70e8be366e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TPS_2
		 (.oe(tmpOE__TPS_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TPS_2_net[0:0]}),
		  .analog({Net_910}),
		  .io({tmpIO_0__TPS_2_net[0:0]}),
		  .siovref(tmpSIOVREF__TPS_2_net),
		  .interrupt({tmpINTERRUPT_0__TPS_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TPS_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__APPS_2_net;
	wire [0:0] tmpFB_0__APPS_2_net;
	wire [0:0] tmpIO_0__APPS_2_net;
	wire [0:0] tmpINTERRUPT_0__APPS_2_net;
	electrical [0:0] tmpSIOVREF__APPS_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5e195aa5-59f6-4b8b-b29d-3cc2166d48ca"),
		  ...
		  .input_buffer_sel(2'b00))
		APPS_2
		 (.oe(tmpOE__APPS_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__APPS_2_net[0:0]}),
		  .analog({Net_1109}),
		  .io({tmpIO_0__APPS_2_net[0:0]}),
		  .siovref(tmpSIOVREF__APPS_2_net),
		  .interrupt({tmpINTERRUPT_0__APPS_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__APPS_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__APPS_3_net;
	wire [0:0] tmpFB_0__APPS_3_net;
	wire [0:0] tmpIO_0__APPS_3_net;
	wire [0:0] tmpINTERRUPT_0__APPS_3_net;
	electrical [0:0] tmpSIOVREF__APPS_3_net;

	cy_psoc3_pins_v1_10
		#(.id("014320ed-5c3a-42dc-9a2c-9a4d6f8318bf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		APPS_3
		 (.oe(tmpOE__APPS_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__APPS_3_net[0:0]}),
		  .analog({Net_1111}),
		  .io({tmpIO_0__APPS_3_net[0:0]}),
		  .siovref(tmpSIOVREF__APPS_3_net),
		  .interrupt({tmpINTERRUPT_0__APPS_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__APPS_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
