...
volatile uint8 ADC_DelSig_Config = 1u;

volatile int32 ADC_DelSig_Offset;
volatile int32 ADC_DelSig_CountsPerVolt;
...
static ADC_DelSig_GCOR_STRUCT ADC_DelSig_gcor[ADC_DelSig_DEFAULT_NUM_CONFIGS];
...
***************************************/
static void ADC_DelSig_InitConfig(uint8 config) ;
static void ADC_DelSig_GainCompensation(uint8 inputRange, uint16 idealDecGain, uint16 idealOddDecGain, 
                            uint8 resolution, uint8 config) ;
static void ADC_DelSig_SetDSMRef0Reg(uint8 value) ;
...
void ADC_DelSig_Init(void) 
{
    ...
    ADC_DelSig_Config = 1u;
    ADC_DelSig_convDone = 0u;
    ...
    /* This is only valid if there is an internal clock */
        ...
        CyIntSetPriority(ADC_DelSig_INTC_NUMBER, ADC_DelSig_INTC_PRIOR_NUMBER);
...
#if(ADC_DelSig_MI_ENABLE != 0u) /* Enable Modulator Input */
    ADC_DelSig_DSM_CR3_REG     |= ADC_DelSig_DSM_MODBIT_EN;
#else
    ADC_DelSig_DSM_CR3_REG     = ADC_DelSig_CFG1_DSM_CR3;
#endif /* ADC_DelSig_MI_ENABLE != 0u*/    
    ...
    ADC_DelSig_GainCompensation(ADC_DelSig_CFG1_INPUT_RANGE,
        ...
        ADC_DelSig_GainCompensation(ADC_DelSig_CFG2_INPUT_RANGE,
                                          ADC_DelSig_CFG2_IDEAL_DEC_GAIN,
                                          ADC_DelSig_CFG2_IDEAL_ODDDEC_GAIN,
                                          ADC_DelSig_CFG2_RESOLUTION,
                                          ADC_DelSig_CFG2);
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 1 */
    #if(ADC_DelSig_DEFAULT_NUM_CONFIGS > 2)
        ADC_DelSig_GainCompensation(ADC_DelSig_CFG3_INPUT_RANGE,
                                          ADC_DelSig_CFG3_IDEAL_DEC_GAIN,
                                          ADC_DelSig_CFG3_IDEAL_ODDDEC_GAIN,
                                          ADC_DelSig_CFG3_RESOLUTION,
                                          ADC_DelSig_CFG3);
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 2 */
    #if(ADC_DelSig_DEFAULT_NUM_CONFIGS > 3)
        ADC_DelSig_GainCompensation(ADC_DelSig_CFG4_INPUT_RANGE,
                                          ADC_DelSig_CFG4_IDEAL_DEC_GAIN,
                                          ADC_DelSig_CFG4_IDEAL_ODDDEC_GAIN,
                                          ADC_DelSig_CFG4_RESOLUTION,
                                          ADC_DelSig_CFG4);
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 3 */

    /* Set GCOR register for config1 */
    ADC_DelSig_DEC_GVAL_REG = ADC_DelSig_gcor[ADC_DelSig_Config - 1u].gval;
    CY_SET_REG16(ADC_DelSig_DEC_GCOR_16B_PTR, ADC_DelSig_gcor[ADC_DelSig_Config - 1u].gcor);

    /* Initialize the registers with default customizer settings for config1 */
    ADC_DelSig_InitConfig(ADC_DelSig_Config);
}
...
void ADC_DelSig_Enable(void) 
{
    ...
    /* Code to disable the REFBUF0 if reference chosen is External ref */
        ...
        {
            /* Disable the REFBUF0 */
            ADC_DelSig_DSM_CR17_REG &= (uint8)~ADC_DelSig_DSM_EN_BUF_VREF;
        }
    #endif /* External ref */

    #if (((ADC_DelSig_CFG1_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) || \
         ((ADC_DelSig_DEFAULT_NUM_CONFIGS > 1) && \
        ...
        if(((config == 1u) &&
            (ADC_DelSig_CFG1_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) &&
            ((ADC_DelSig_CFG1_REFERENCE != ADC_DelSig_EXT_REF_ON_P03) &&
             (ADC_DelSig_CFG1_REFERENCE != ADC_DelSig_EXT_REF_ON_P32))) ||
             ((config == 2u) &&
              (ADC_DelSig_CFG2_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) &&
    ...
    CyDelayUs(ADC_DelSig_PRES_DELAY_TIME);

    /* Enable the press circuit */
    ADC_DelSig_RESET_CR4_REG &= (uint8)~ADC_DelSig_IGNORE_PRESA1;
    ADC_DelSig_RESET_CR5_REG &= (uint8)~ADC_DelSig_IGNORE_PRESA2;
    ...
    ADC_DelSig_STBY_PWRMGR_CHARGE_PUMP_CLK_REG |= ADC_DelSig_STBY_PWR_CHARGE_PUMP_CLK_EN;
        ...
        CyIntClearPending(ADC_DelSig_INTC_NUMBER);
        /* Enable interrupt */
        CyIntEnable(ADC_DelSig_INTC_NUMBER);
    #endif   /* End ADC_DelSig_IRQ_REMOVE */
...
*  ADC_DelSig_SelectConfiguration( ) function has been called to change
*  the default setting.
*
* Parameters:
*  None
...
void ADC_DelSig_Stop(void) 
{
    ...
    /* Stop conversions */
    ADC_DelSig_DEC_CR_REG &= (uint8)~ADC_DelSig_DEC_START_CONV;
    ...
    ADC_DelSig_DSM_CR17_REG &= (uint8)~(ADC_DelSig_DSM_EN_BUF_VREF | ADC_DelSig_DSM_EN_BUF_VCM);
    ADC_DelSig_DSM_REF0_REG &= (uint8)~ADC_DelSig_DSM_EN_BUF_VREF_INN;
    ...
    ADC_DelSig_PWRMGR_DSM_REG &= (uint8)~ADC_DelSig_ACT_PWR_DSM_EN;

    /* Disable power to Decimator block */
    ADC_DelSig_PWRMGR_DEC_REG &= (uint8)~ADC_DelSig_ACT_PWR_DEC_EN;

    /* Disable alternative active power to the ADC */
    ADC_DelSig_STBY_PWRMGR_DEC_REG &= (uint8)~ADC_DelSig_STBY_PWR_DEC_EN;
    ADC_DelSig_STBY_PWRMGR_DSM_REG &= (uint8)~ADC_DelSig_STBY_PWR_DSM_EN;

   /* Disable negative pumps for DSM  */
    ADC_DelSig_PUMP_CR1_REG &= (uint8)~(ADC_DelSig_PUMP_CR1_CLKSEL | ADC_DelSig_PUMP_CR1_FORCE );

    /* This is only valid if there is an internal clock */
    #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
        ADC_DelSig_PWRMGR_CLK_REG &= (uint8)~ADC_DelSig_ACT_PWR_CLK_EN;
        ADC_DelSig_STBY_PWRMGR_CLK_REG &= (uint8)~ADC_DelSig_STBY_PWR_CLK_EN;
    #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */

    /* Disable Modulator Chopping */
    ADC_DelSig_DSM_CR2_REG &= (uint8)~ADC_DelSig_DSM_MOD_CHOP_EN;
    /* Disable power to charge pump clock */
    ADC_DelSig_PWRMGR_CHARGE_PUMP_CLK_REG &= (uint8)~ADC_DelSig_ACT_PWR_CHARGE_PUMP_CLK_EN;
    ADC_DelSig_STBY_PWRMGR_CHARGE_PUMP_CLK_REG &= (uint8)~ADC_DelSig_STBY_PWR_CHARGE_PUMP_CLK_EN;
...
{
    uint8 tmpReg;
    tmpReg = ADC_DelSig_DSM_BUF1_REG & (uint8)~ADC_DelSig_DSM_GAIN_MASK;
    tmpReg |= (uint8)(gain << ADC_DelSig_DSM_GAIN_SHIFT) & ADC_DelSig_DSM_GAIN_MASK;
...
void ADC_DelSig_SetCoherency(uint8 coherency) 
{
    ...
    tmpReg = ADC_DelSig_DEC_COHER_REG & (uint8)~ADC_DelSig_DEC_SAMP_KEY_MASK;
    tmpReg |= coherency & ADC_DelSig_DEC_SAMP_KEY_MASK;
...
uint8 ADC_DelSig_SetGCOR(float32 gainAdjust) 
{
    ...
    tmpReg = ADC_DelSig_gcor[ADC_DelSig_Config - 1u].gcor;
    tmpValue = ((float32)tmpReg / (float32)ADC_DelSig_IDEAL_GAIN_CONST);
    ...
    {
        tmpValue *= (float32)ADC_DelSig_IDEAL_GAIN_CONST;
		tmpReg = (uint16)tmpValue;
        CY_SET_REG16(ADC_DelSig_DEC_GCOR_16B_PTR, tmpReg);
        /* Update gain array to be used by SelectConfiguration() API */
       ADC_DelSig_gcor[ADC_DelSig_Config - 1u].gcor = tmpReg;
...
uint16 ADC_DelSig_ReadGCOR(void) 
{
    ...
    gcorValue = CY_GET_REG16(ADC_DelSig_DEC_GCOR_16B_PTR);

    if (gValue < ADC_DelSig_MAX_GVAL)
    {
        gcorValue <<= ADC_DelSig_MAX_GVAL - gValue;
    }
...
*   ADC_DelSig_RETURN_STATUS -   Immediately returns conversion result
*                                      status.
*   ADC_DelSig_WAIT_FOR_RESULT - Does not return until ADC conversion
*                                      is complete.
*
* Return:
...
uint8 ADC_DelSig_IsEndConversion(uint8 retMode) 
{
    ...
    do
    {
        ...
        */
        if(ADC_DelSig_stopConversion != 0u)
        {
    ...
    }while((status != ADC_DelSig_DEC_CONV_DONE) && (retMode == ADC_DelSig_WAIT_FOR_RESULT));
...
*
* Global variables:
*  ADC_DelSig_convDone:  Cleared in single sample mode with resolution
*                              above 16 bits
*
*******************************************************************************/
int8 ADC_DelSig_GetResult8( void ) 
{
    ...
    coherency = ADC_DelSig_DEC_COHER_REG & ADC_DelSig_DEC_SAMP_KEY_MASK;

    result = (int8)ADC_DelSig_DEC_SAMP_REG;

    if(coherency == ADC_DelSig_DEC_SAMP_KEY_MID)
    {   /* Dummy read of the middle byte to unlock the coherency */
        (void)ADC_DelSig_DEC_SAMPM_REG;
    }
    else  if(coherency == ADC_DelSig_DEC_SAMP_KEY_HIGH)
    {   /* Dummy read of the MSB byte to unlock the coherency */
        (void)ADC_DelSig_DEC_SAMPH_REG;
    }
...
int16 ADC_DelSig_GetResult16(void) 
{
    ...
    if(coherency <= ADC_DelSig_DEC_SAMP_KEY_LOW)
    {   /*  Use default method to read result registers i.e. LSB byte read at the end*/
        #if (CY_PSOC3)
            result = ADC_DelSig_DEC_SAMPM_REG;
            result = (result << 8u) | ADC_DelSig_DEC_SAMP_REG;
        #else
            result = (CY_GET_REG16(ADC_DelSig_DEC_SAMP_16B_PTR));
        #endif /* CY_PSOC3 */
    }
    else /* MID or HIGH */
    {   /* Read middle byte at the end */
            ...
            result = (CY_GET_REG16(ADC_DelSig_DEC_SAMP_16B_PTR));
        #else
            result = ADC_DelSig_DEC_SAMP_REG;
            result |=  (uint16)((uint16)ADC_DelSig_DEC_SAMPM_REG << 8u);
        #endif /* CY_PSOC3 */
        if(coherency == ADC_DelSig_DEC_SAMP_KEY_HIGH)
        {   /* Dummy read of the MSB byte to unlock the coherency */
            (void)ADC_DelSig_DEC_SAMPH_REG;
        }
    }
...
int32 ADC_DelSig_GetResult32(void) 
{
    ...
    {   /*  Use default method to read result registers i.e. LSB byte read at the end*/
        #if (CY_PSOC3)
            result = ADC_DelSig_DEC_SAMPH_REG;
            if((result & 0x80u) != 0u)
            {   /* Sign extend */
                result |= 0xFF00u;
            }
            result = (result << 8u) | ADC_DelSig_DEC_SAMPM_REG;
            result = (result << 8u) | ADC_DelSig_DEC_SAMP_REG;
        #else
            result = CY_GET_REG16(ADC_DelSig_DEC_SAMPH_16B_PTR);
            result = (result << 16u) | (CY_GET_REG16(ADC_DelSig_DEC_SAMP_16B_PTR));
        #endif /* CY_PSOC3 */
    }
    else if(coherency == ADC_DelSig_DEC_SAMP_KEY_MID)
    {   /* Read middle byte at the end */
        #if (CY_PSOC3)
            result = ADC_DelSig_DEC_SAMPH_REG;
            if((result & 0x80u) != 0u)
        ...
        #else
            result = CY_GET_REG16(ADC_DelSig_DEC_SAMPH_16B_PTR);
            result = (result << 16u) | ADC_DelSig_DEC_SAMP_REG;
            result |=  (uint32)((uint32)ADC_DelSig_DEC_SAMPM_REG << 8u);
        #endif /* CY_PSOC3 */
    }
    else /*ADC_DelSig_DEC_SAMP_KEY_HIGH */
    {
        /* Read MSB byte at the end */
        #if (CY_PSOC3)
            result = CY_GET_REG16(ADC_DelSig_DEC_SAMP_16B_PTR);
			tmp = ADC_DelSig_DEC_SAMPH_REG;
            if((tmp & 0x80u) != 0u)
            {   /* Sign extend */
                tmp |= 0xFF00u;
            }
        ...
        #else
            result = CY_GET_REG16(ADC_DelSig_DEC_SAMP_16B_PTR);
            result |= (uint32)((uint32)CY_GET_REG16(ADC_DelSig_DEC_SAMPH_16B_PTR) << 16u);
        #endif /* CY_PSOC3 */
    }
    /* Clear conversion complete status in Single Sample mode with resolution above 16 bit */
    if(ADC_DelSig_stopConversion != 0u)
...
int16 ADC_DelSig_CountsTo_mVolts(int32 adcCounts) 
{
    ...
    #if(ADC_DelSig_CFG1_DEC_DIV != 0)
        if(ADC_DelSig_Config == ADC_DelSig_CFG1)
        {
            adcCounts /= ADC_DelSig_CFG1_DEC_DIV;
        }
    #endif /* ADC_DelSig_CFG1_DEC_DIV */
    #if((ADC_DelSig_CFG2_DEC_DIV != 0) && (ADC_DelSig_DEFAULT_NUM_CONFIGS > 1))
        if(ADC_DelSig_Config == ADC_DelSig_CFG2)
        {
            adcCounts /= ADC_DelSig_CFG2_DEC_DIV;
        }
    #endif /* ADC_DelSig_CFG2_DEC_DIV */
    #if((ADC_DelSig_CFG3_DEC_DIV != 0) && (ADC_DelSig_DEFAULT_NUM_CONFIGS > 2))
        if(ADC_DelSig_Config == ADC_DelSig_CFG3)
        {
            adcCounts /= ADC_DelSig_CFG3_DEC_DIV;
        }
    #endif /* ADC_DelSig_CFG2_DEC_DIV */
    #if((ADC_DelSig_CFG4_DEC_DIV != 0) && (ADC_DelSig_DEFAULT_NUM_CONFIGS > 3))
        if(ADC_DelSig_Config == ADC_DelSig_CFG4)
        {
            adcCounts /= ADC_DelSig_CFG4_DEC_DIV;
        }
    #endif /* ADC_DelSig_CFG2_DEC_DIV */
    ...
    mVolts = (int16)(( adcCounts * ADC_DelSig_1MV_COUNTS ) / ADC_DelSig_CountsPerVolt) ;
...
float32 ADC_DelSig_CountsTo_Volts(int32 adcCounts) 
{
    ...
    Volts = (float32)adcCounts / (float32)ADC_DelSig_CountsPerVolt;
...
int32 ADC_DelSig_CountsTo_uVolts(int32 adcCounts) 
{
    ...
    else if (ADC_DelSig_Config == ADC_DelSig_CFG2)
    {
        resolution = ADC_DelSig_CFG2_RESOLUTION;
        #if(ADC_DelSig_CFG2_DEC_DIV != 0)
            adcCounts /= ADC_DelSig_CFG2_DEC_DIV;
        #endif /* ADC_DelSig_CFG2_DEC_DIV */
    }
    else if (ADC_DelSig_Config == ADC_DelSig_CFG3)
    {
        resolution = ADC_DelSig_CFG3_RESOLUTION;
        #if(ADC_DelSig_CFG3_DEC_DIV != 0)
            adcCounts /= ADC_DelSig_CFG3_DEC_DIV;
        #endif /* ADC_DelSig_CFG3_DEC_DIV */
    }
    else
    {
        resolution = ADC_DelSig_CFG4_RESOLUTION;
        #if(ADC_DelSig_CFG4_DEC_DIV != 0)
            adcCounts /= ADC_DelSig_CFG4_DEC_DIV;
        #endif /* ADC_DelSig_CFG4_DEC_DIV */
    }

    switch (resolution)
    {
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_12) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_12) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_12) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_12) )
            case (uint8)ADC_DelSig__BITS_12:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_2;
                coefB = ADC_DelSig_DIVISOR_2;
                break;
        #endif /* ADC_DelSig__BITS_12 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_13) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_13) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_13) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_13) )
            case (uint8)ADC_DelSig__BITS_13:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_4;
                coefB = ADC_DelSig_DIVISOR_4;
                break;
        #endif /* ADC_DelSig__BITS_13 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_14) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_14) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_14) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_14) )
            case (uint8)ADC_DelSig__BITS_14:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_8;
                coefB = ADC_DelSig_DIVISOR_8;
                break;
        #endif /* ADC_DelSig__BITS_14 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_15) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_15) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_15) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_15) )
            case (uint8)ADC_DelSig__BITS_15:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_16;
                coefB = ADC_DelSig_DIVISOR_16;
                break;
        #endif /* ADC_DelSig__BITS_15 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_16) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_16) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_16) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_16) )
            case (uint8)ADC_DelSig__BITS_16:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_32;
                coefB = ADC_DelSig_DIVISOR_32;
                break;
        #endif /* ADC_DelSig__BITS_16 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_17) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_17) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_17) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_17) )
            case (uint8)ADC_DelSig__BITS_17:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_64;
                coefB = ADC_DelSig_DIVISOR_64;
                break;
        #endif /* ADC_DelSig__BITS_17 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_18) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_18) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_18) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_18) )
            case (uint8)ADC_DelSig__BITS_18:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_125;
                coefB = ADC_DelSig_DIVISOR_125;
                break;
        #endif /* ADC_DelSig__BITS_18 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_19) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_19) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_19) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_19) )
            case (uint8)ADC_DelSig__BITS_19:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_250;
                coefB = ADC_DelSig_DIVISOR_250;
                break;
        #endif /* ADC_DelSig__BITS_19 */    
        #if( (ADC_DelSig_CFG1_RESOLUTION == ADC_DelSig__BITS_20) || \
             (ADC_DelSig_CFG2_RESOLUTION == ADC_DelSig__BITS_20) || \
             (ADC_DelSig_CFG3_RESOLUTION == ADC_DelSig__BITS_20) || \
             (ADC_DelSig_CFG4_RESOLUTION == ADC_DelSig__BITS_20) )
            case (uint8)ADC_DelSig__BITS_20:
                coefA = ADC_DelSig_1UV_COUNTS / ADC_DelSig_DIVISOR_500;
                coefB = ADC_DelSig_DIVISOR_500;
                break;
        #endif /* ADC_DelSig__BITS_20 */    
        default:    /* resolution < 12 */
            /* 11 bits ADC + 2^20(1048576) = 31 bits */
            coefA = ADC_DelSig_1UV_COUNTS;
            coefB = ADC_DelSig_DIVISOR_1;
            break;
    }
    coefB = ADC_DelSig_CountsPerVolt / coefB;
    uVolts = ((coefA * adcCounts) / coefB) - ((coefA * ADC_DelSig_Offset) / coefB);
...
*
* Side Effects: Rewrites the coherency set by ADC_DelSig_SetCoherency()
...
static void ADC_DelSig_InitConfig(uint8 config) 
{
    ...
    if (config == 1u)
    {
        ...
        ADC_DelSig_SetDSMRef0Reg(ADC_DelSig_CFG1_DSM_REF0);
        ...
        */
        #if(ADC_DelSig_DEFAULT_INPUT_MODE)
            #if (ADC_DelSig_CFG1_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF)
                ADC_DelSig_AMux_Select(1u);
            #else
                ADC_DelSig_AMux_Select(0u);
        ...
        */
            ...
            ADC_DelSig_stopConversion = 1u;
        #endif /* Single sample with resolution above 16 bits. */

        ADC_DelSig_CountsPerVolt = (int32)ADC_DelSig_CFG1_COUNTS_PER_VOLT;

        ADC_DelSig_Ext_CP_Clk_SetDividerRegister(ADC_DelSig_CFG1_CP_CLK_DIVIDER, 1u);

        /* This is only valid if there is an internal clock */
        #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
            ADC_DelSig_theACLK_SetDividerRegister(ADC_DelSig_CFG1_ADC_CLK_DIVIDER, 1u);
        #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */

        #if(ADC_DelSig_IRQ_REMOVE == 0u)
            /* Set interrupt vector */
            (void)CyIntSetVector(ADC_DelSig_INTC_NUMBER, &ADC_DelSig_ISR1);
        #endif   /* End ADC_DelSig_IRQ_REMOVE */
    }
        ...
        if(config == 2u)
        {
            ...
            ADC_DelSig_DEC_COHER_REG   = ADC_DelSig_CFG2_DEC_COHER;
            ...
            ADC_DelSig_SetDSMRef0Reg(ADC_DelSig_CFG2_DSM_REF0);
            ...
            */
                ...
                ADC_DelSig_CFG2_CONV_MODE == ADC_DelSig_MODE_SINGLE_SAMPLE)
                ADC_DelSig_stopConversion = 1u;
            #endif /* Single sample with resolution above 16 bits. */

            ADC_DelSig_CountsPerVolt = (int32)ADC_DelSig_CFG2_COUNTS_PER_VOLT;

            ADC_DelSig_Ext_CP_Clk_SetDividerRegister(ADC_DelSig_CFG2_CP_CLK_DIVIDER, 1u);

            /* This is only valid if there is an internal clock */
            #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
                ADC_DelSig_theACLK_SetDividerRegister(ADC_DelSig_CFG2_ADC_CLK_DIVIDER, 1u);
            #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */

            #if(ADC_DelSig_IRQ_REMOVE == 0u)
                /* Set interrupt vector */
                (void)CyIntSetVector(ADC_DelSig_INTC_NUMBER, &ADC_DelSig_ISR2);
            #endif   /* End ADC_DelSig_IRQ_REMOVE */
        }
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 1 */
        ...
        if(config == 3u)
        {
            ...
            ADC_DelSig_DEC_COHER_REG   = ADC_DelSig_CFG3_DEC_COHER;
            ...
            /* Set DSM_REF0_REG by disabling and enabling the PRESS circuit */
            ADC_DelSig_SetDSMRef0Reg(ADC_DelSig_CFG3_DSM_REF0);
            ...
            */
            ...
            /* Set the Conversion stop if resolution is above 16 bit and
               conversion  mode is Single sample */
                ...
                ADC_DelSig_CFG3_CONV_MODE == ADC_DelSig_MODE_SINGLE_SAMPLE)
                ADC_DelSig_stopConversion = 1u;
            #endif /* Single sample with resolution above 16 bits */

            ADC_DelSig_CountsPerVolt = (int32)ADC_DelSig_CFG3_COUNTS_PER_VOLT;

            ADC_DelSig_Ext_CP_Clk_SetDividerRegister(ADC_DelSig_CFG3_CP_CLK_DIVIDER, 1u);

            /* This is only valid if there is an internal clock */
            #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
                ADC_DelSig_theACLK_SetDividerRegister(ADC_DelSig_CFG3_ADC_CLK_DIVIDER, 1u);
            #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */

            #if(ADC_DelSig_IRQ_REMOVE == 0u)
                /* Set interrupt vector */
                (void)CyIntSetVector(ADC_DelSig_INTC_NUMBER, &ADC_DelSig_ISR3);
            #endif   /* End ADC_DelSig_IRQ_REMOVE */
        }
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 2 */
        ...
        if (config == 4u)
        {
            ...
            ADC_DelSig_DEC_COHER_REG   = ADC_DelSig_CFG4_DEC_COHER;
            ...
            /* Set DSM_REF0_REG by disabling and enabling the PRESS circuit */
            ADC_DelSig_SetDSMRef0Reg(ADC_DelSig_CFG4_DSM_REF0);
            ...
            */
            ...
            /* Set the Conversion stop if resolution is above 16 bit and
               conversion mode is Single sample */
                ...
                ADC_DelSig_CFG4_CONV_MODE == ADC_DelSig_MODE_SINGLE_SAMPLE)
                ADC_DelSig_stopConversion = 1u;
            #endif /* Single sample with resolution above 16 bits */

            ADC_DelSig_CountsPerVolt = (int32)ADC_DelSig_CFG4_COUNTS_PER_VOLT;

            ADC_DelSig_Ext_CP_Clk_SetDividerRegister(ADC_DelSig_CFG4_CP_CLK_DIVIDER, 1u);

            /* This is only valid if there is an internal clock */
            #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
                ADC_DelSig_theACLK_SetDividerRegister(ADC_DelSig_CFG4_ADC_CLK_DIVIDER, 1u);
            #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */

            #if(ADC_DelSig_IRQ_REMOVE == 0u)
                /* Set interrupt vector */
                (void)CyIntSetVector(ADC_DelSig_INTC_NUMBER, &ADC_DelSig_ISR4);
            #endif   /* End ADC_DelSig_IRQ_REMOVE */
        }
    #endif /* ADC_DelSig_DEFAULT_NUM_CONFIGS > 3 */
}
...
/*******************************************************************************
* Function Name: ADC_DelSig_SelectCofiguration
********************************************************************************
*
* Summary:
...
*  restarted. If this value is zero, then user must call ADC_DelSig_Start
*  and ADC_DelSig_StartConvert() to restart the conversion.
*
* Parameters:
                                              ...
                                              
{
    ...
    if((config > 0u) && (config <= ADC_DelSig_DEFAULT_NUM_CONFIGS))
    {
		...
		*/
        ...
        /* Compensate the gain */
        ADC_DelSig_DEC_GVAL_REG = ADC_DelSig_gcor[config - 1u].gval;
        CY_SET_REG16(ADC_DelSig_DEC_GCOR_16B_PTR, ADC_DelSig_gcor[config - 1u].gcor);
...
/*******************************************************************************
* Function Name: ADC_DelSig_GainCompensation
********************************************************************************
*
* Summary:
                              ...
                              uint8 resolution, uint8 config) 
{
    ...
    if((config > 0u) && (config <= ADC_DelSig_DEFAULT_NUM_CONFIGS))
    {
        switch(inputRange)
        {
            ...
            case ADC_DelSig_IR_VSSA_TO_2VREF:
        ...
        if (resolution < (ADC_DelSig_MAX_GVAL - 1u))
        {
            gcorValue = (gcorValue >> (ADC_DelSig_MAX_GVAL - (resolution + 1u)));
            ADC_DelSig_gcor[config - 1u].gval = (resolution + 1u);
        }
        else
        {
            /* Use all 16 bits */
            ADC_DelSig_gcor[config - 1u].gval = ADC_DelSig_MAX_GVAL;
        }

        /* Save the gain correction register value */
        ADC_DelSig_gcor[config - 1u].gcor = gcorValue;
    }
    else
    {
        /* Halt CPU in debug mode if config is out of valid range */
...
/******************************************************************************
* Function Name: ADC_DelSig_SetDSMRef0Reg(uint8)
******************************************************************************
*
* Summary:
...
static void ADC_DelSig_SetDSMRef0Reg(uint8 value) 
{
    ...
    /* Disable PRES, Enable power to VCMBUF0, REFBUF0 and REFBUF1, enable PRES */
    ADC_DelSig_RESET_CR4_REG |= (ADC_DelSig_IGNORE_PRESA1 | ADC_DelSig_IGNORE_PRESD1);
    ADC_DelSig_RESET_CR5_REG |= (ADC_DelSig_IGNORE_PRESA2 | ADC_DelSig_IGNORE_PRESD2);
    ADC_DelSig_DSM_REF0_REG = value;

    /* Wait for 3 microseconds */
    CyDelayUs(ADC_DelSig_PRES_DELAY_TIME);
    /* Enable the press circuit */
    ADC_DelSig_RESET_CR4_REG &= (uint8)~(ADC_DelSig_IGNORE_PRESA1 | ADC_DelSig_IGNORE_PRESD1);
    ADC_DelSig_RESET_CR5_REG &= (uint8)~(ADC_DelSig_IGNORE_PRESA2 | ADC_DelSig_IGNORE_PRESD2);
...
/*******************************************************************************
* Function Name: ADC_DelSig_Read8
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ADC_DelSig_Read16
********************************************************************************
*
* Summary:
*  This function simplifies getting results from the ADC when only a
...
/*******************************************************************************
* Function Name: ADC_DelSig_Read32
********************************************************************************
*
* Summary:
*  This function simplifies getting results from the ADC when only a
