...
void ADC_SAR_Seq_SAR_Enable(void)
{
    ...
    #endif /* ADC_SAR_Seq_SAR_HIGH_POWER_PULSE == 0u */
    ...
    */
    #if(ADC_SAR_Seq_SAR_HIGH_POWER_PULSE == 0u)    /* MinPulseWidth <= 50 ns */
        ADC_SAR_Seq_SAR_SAR_CSR5_REG |= ADC_SAR_Seq_SAR_SAR_SEL_CSEL_DFT_CHAR;
    #else /* for <500ksps */
        ADC_SAR_Seq_SAR_SAR_CSR5_REG &= (uint8)~ADC_SAR_Seq_SAR_SAR_SEL_CSEL_DFT_CHAR;
    #endif /* ADC_SAR_Seq_SAR_HIGH_POWER_PULSE == 0u */
...
/*******************************************************************************
* Function Name: ADC_SAR_Seq_SAR_SetScaledGain
********************************************************************************
*
* Summary:
