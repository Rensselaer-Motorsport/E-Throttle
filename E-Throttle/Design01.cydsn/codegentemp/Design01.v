...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_2, CY_INSTANCE_SHORT_NAME=Opamp_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2 SP1, INSTANCE_NAME=Opamp_2, )
...
module ADC_SAR_SEQ_P4_v2_20_2 (
    ...
    cy_psoc4_sarmux_v1_0 cy_psoc4_sarmux_8 (
        ...
        .vout_plus(Net_2794),
        .vout_minus(Net_2793));
    defparam cy_psoc4_sarmux_8.input_mode = "1100";
	...
	cy_clock_v1_0
		#(.id("9a67a4bd-024a-4dec-ac06-ad54a4dde89a/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("678168402.777778"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1, CY_INSTANCE_SHORT_NAME=Opamp_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2 SP1, INSTANCE_NAME=Opamp_1, )
...
module top ;
	...
	wire [0:0] tmpOE__Input_4_net;
	wire [0:0] tmpFB_0__Input_4_net;
	wire [0:0] tmpIO_0__Input_4_net;
	wire [0:0] tmpINTERRUPT_0__Input_4_net;
	electrical [0:0] tmpSIOVREF__Input_4_net;

	cy_psoc3_pins_v1_10
		#(.id("80f95e32-0a3e-4d8e-a3c7-50dd7ad49398"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Input_4
		 (.oe(tmpOE__Input_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Input_4_net[0:0]}),
		  .analog({Net_562}),
		  .io({tmpIO_0__Input_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Input_4_net),
		  .interrupt({tmpINTERRUPT_0__Input_4_net[0:0]}),
		  .annotation({Net_343}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Input_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Input_3_net;
	wire [0:0] tmpFB_0__Input_3_net;
	wire [0:0] tmpIO_0__Input_3_net;
	wire [0:0] tmpINTERRUPT_0__Input_3_net;
	electrical [0:0] tmpSIOVREF__Input_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0b0fcf5d-629b-4f61-a95a-c0d71e4b1f3e"),
		  ...
		  .input_buffer_sel(2'b00))
		Input_3
		 (.oe(tmpOE__Input_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Input_3_net[0:0]}),
		  .analog({Net_561}),
		  .io({tmpIO_0__Input_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Input_3_net),
		  .interrupt({tmpINTERRUPT_0__Input_3_net[0:0]}),
		  .annotation({Net_342}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Input_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Differential_In_2_net;
	wire [0:0] tmpFB_0__Differential_In_2_net;
	wire [0:0] tmpIO_0__Differential_In_2_net;
	wire [0:0] tmpINTERRUPT_0__Differential_In_2_net;
	electrical [0:0] tmpSIOVREF__Differential_In_2_net;

	cy_psoc3_pins_v1_10
		#(.id("5edf3d3f-ab30-45ec-9a40-0ef3a2e4a27b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Differential_In_2
		 (.oe(tmpOE__Differential_In_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Differential_In_2_net[0:0]}),
		  .analog({Net_560}),
		  .io({tmpIO_0__Differential_In_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Differential_In_2_net),
		  .interrupt({tmpINTERRUPT_0__Differential_In_2_net[0:0]}),
		  .annotation({Net_341}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Differential_In_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Differential_In_1_net;
	wire [0:0] tmpFB_0__Differential_In_1_net;
	wire [0:0] tmpIO_0__Differential_In_1_net;
	wire [0:0] tmpINTERRUPT_0__Differential_In_1_net;
	electrical [0:0] tmpSIOVREF__Differential_In_1_net;

	cy_psoc3_pins_v1_10
		#(.id("0eb17b09-a287-4224-a81d-9e870b622107"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Differential_In_1
		 (.oe(tmpOE__Differential_In_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Differential_In_1_net[0:0]}),
		  .analog({Net_575}),
		  .io({tmpIO_0__Differential_In_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Differential_In_1_net),
		  .interrupt({tmpINTERRUPT_0__Differential_In_1_net[0:0]}),
		  .annotation({Net_340}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Differential_In_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0fca6a2c-3c46-4228-8d99-b5dca2ac5ea6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9f4a2922-f057-460f-9b41-6294797173bf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Rg (
        .connect({
            Net_336,
            Net_335
        })
    );
    defparam Rg.comp_name = "Resistor_v1_0";
    defparam Rg.port_names = "T1, T2";
    defparam Rg.width = 2;

	wire [0:0] tmpOE__Preamp_In_2_net;
	wire [0:0] tmpFB_0__Preamp_In_2_net;
	wire [0:0] tmpIO_0__Preamp_In_2_net;
	wire [0:0] tmpINTERRUPT_0__Preamp_In_2_net;
	electrical [0:0] tmpSIOVREF__Preamp_In_2_net;

	cy_psoc3_pins_v1_10
		#(.id("e8f72ea1-086e-459f-b6f7-5210741ce550"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Preamp_In_2
		 (.oe(tmpOE__Preamp_In_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Preamp_In_2_net[0:0]}),
		  .analog({Net_554}),
		  .io({tmpIO_0__Preamp_In_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Preamp_In_2_net),
		  .interrupt({tmpINTERRUPT_0__Preamp_In_2_net[0:0]}),
		  .annotation({Net_337}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Preamp_In_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Inv_2_net;
	wire [0:0] tmpFB_0__Inv_2_net;
	wire [0:0] tmpIO_0__Inv_2_net;
	wire [0:0] tmpINTERRUPT_0__Inv_2_net;
	electrical [0:0] tmpSIOVREF__Inv_2_net;

	cy_psoc3_pins_v1_10
		#(.id("3654174f-60f4-4bb0-ac1e-a121c7edec32"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Inv_2
		 (.oe(tmpOE__Inv_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Inv_2_net[0:0]}),
		  .analog({Net_555}),
		  .io({tmpIO_0__Inv_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Inv_2_net),
		  .interrupt({tmpINTERRUPT_0__Inv_2_net[0:0]}),
		  .annotation({Net_336}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Inv_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Inv_1_net;
	wire [0:0] tmpFB_0__Inv_1_net;
	wire [0:0] tmpIO_0__Inv_1_net;
	wire [0:0] tmpINTERRUPT_0__Inv_1_net;
	electrical [0:0] tmpSIOVREF__Inv_1_net;

	cy_psoc3_pins_v1_10
		#(.id("3c695f79-cd0a-4499-9f97-3742c0a634f6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Inv_1
		 (.oe(tmpOE__Inv_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Inv_1_net[0:0]}),
		  .analog({Net_331}),
		  .io({tmpIO_0__Inv_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Inv_1_net),
		  .interrupt({tmpINTERRUPT_0__Inv_1_net[0:0]}),
		  .annotation({Net_335}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Inv_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Preamp_In_1_net;
	wire [0:0] tmpFB_0__Preamp_In_1_net;
	wire [0:0] tmpIO_0__Preamp_In_1_net;
	wire [0:0] tmpINTERRUPT_0__Preamp_In_1_net;
	electrical [0:0] tmpSIOVREF__Preamp_In_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d44d0fea-0085-48a1-82c3-354be77a6259"),
		  ...
		  .input_buffer_sel(2'b00))
		Preamp_In_1
		 (.oe(tmpOE__Preamp_In_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Preamp_In_1_net[0:0]}),
		  .analog({Net_330}),
		  .io({tmpIO_0__Preamp_In_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Preamp_In_1_net),
		  .interrupt({tmpINTERRUPT_0__Preamp_In_1_net[0:0]}),
		  .annotation({Net_334}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Preamp_In_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    OpAmp_P4_v1_10_1 Opamp_2 (
        .Vplus(Net_554),
        .Vout(Net_577),
        .Vminus(Net_555));
