...
extern void BRAKE_ADC_AMux_Set(uint8 channel);
extern void BRAKE_ADC_AMux_Unset(uint8 channel);
/* BRAKE_ADC_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE BRAKE_ADC_AMux__addrTable[2];
/* BRAKE_ADC_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE BRAKE_ADC_AMux__maskTable[2];
